...
import { Center, Button, Heading, VStack, HStack, Text, Image, Link}  from "@chakra-ui/react";
            ...
            <Center bg="pink" width="100%" color="white" padding={24}>
              <VStack>
                ...
                <HStack padding={16} spacing={16}>
                  <Image 
                  src={bobaInfo["photos"][0]}
                  boxSize="210px"
                  objectFit="cover"
                  ></Image>
                  <Image 
                  src={bobaInfo["photos"][1]}
                  boxSize="210px"
                  objectFit="cover"
                  ></Image>
                  <Image 
                  src={bobaInfo["photos"][2]}
                  boxSize="210px"
                  objectFit="cover"
                  ></Image>
                </HStack>
